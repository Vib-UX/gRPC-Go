...
type CalcClient interface {
	// Unary api
	Add(ctx context.Context, in *SumReq, opts ...grpc.CallOption) (*SumRes, error)
}
...
func (c *calcClient) Add(ctx context.Context, in *SumReq, opts ...grpc.CallOption) (*SumRes, error) {
	out := new(SumRes)
...
type CalcServer interface {
	// Unary api
	Add(context.Context, *SumReq) (*SumRes, error)
...
func (UnimplementedCalcServer) Add(context.Context, *SumReq) (*SumRes, error) {
...
func _Calc_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServer).Add(ctx, req.(*SumReq))
	}
